...
module.exports.ROUTER_WHITE_LIST = [
    ...
    route('/getTypeList', 'GET'),
    route('/getSortList', 'GET'),
    route('/product/list', 'GET'),
    route('/detail', 'GET'),
    route('/homedetail', 'GET'),
    route('/carousel/list', 'GET'),
    route('/product/searchByType', 'GET'),
    route('/address/list', 'GET'),
    route('/address/add', 'POST'),
    route('/address/del', 'DELETE'),
    route('/address/edit', 'POST'),
    route('/comment/all', 'GET')
];